    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authz -> authz
                        .requestMatchers("/login", "/register/**", "/", "/forgot-password/**", "/more-products", "/accessory", "/contact", "/chat").permitAll()
                        ...
                        .requestMatchers("/management/staff").hasRole("ADMIN")
                        .requestMatchers("/management/statistical-report").hasRole("ADMIN")
